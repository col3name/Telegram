package org.telegram.ui.Components.profileAnim;
...
public class QuickShareSelectorDrawable extends Drawable implements Animator.AnimatorListener {
    ...
    public QuickShareSelectorDrawable(
        ...
        avatarCells = new QuickShareAvatarCell[Math.min(1, dialogs.size())];
...
//   buttonCurrent = RectF(929.0, 1770.0, 1017.0, 1858.0)
//    ballLeft = RectF(901.00214, 1800.5, 929.00214, 1828.5)
//    ballRight = RectF(1016.9978, 1800.5, 1044.9978, 1828.5)
//boolean ballsConnected = Math.sqrt(bdx * bdx + bdy * bdy) <= (ballLeft.width() + ballRight.width()) / 2;
//    ballLeftOnCircle = true

    //    ballRightOnCircle = true
    ...
    private void arcTo(Path path, RectF rectF, float startAngle, float endAngle, boolean clockwise, boolean strictMode) {
        ...
        System.out.println("QuickForward" + startAngle + ":" + sweepAngle);
